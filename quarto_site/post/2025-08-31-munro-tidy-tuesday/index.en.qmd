...
I contacted walkhighlands to ask permission to share what I've done and they said yes because they're lovely. I've still decided not to include the code I used for web scraping so I don't inadvertently cuse them any issues and so I'll just describe roughly what I did instead.
...
write_csv(x = joined_dat, file = "combined_data.csv")
