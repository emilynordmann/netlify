...
route_dat <-corbett_dat |>
  select(first_route_url, first_route_title,
         region, time_hours_min:cow, time, scramble_exposed, wet, type) |>
  unique()
...
corbett_map <- corbett_dat %>%
  select(name, region, xcoord, ycoord, height_dobih, pathless, scramble_exposed, wet, toilet, pub, bothy, deer_fence, car_park, cow) %>%
  na.omit()
