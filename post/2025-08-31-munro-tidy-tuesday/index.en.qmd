...
route_dat <-munro_dat |>
  select(first_route_url, first_route_title,
         region, time_hours_min:cow, time, scramble_exposed, wet) |>
  unique()
...
munros_map <- munro_dat %>%
  select(munro, region, xcoord, ycoord, height_dobih, scramble_exposed, wet, toilet, pub, bothy, deer_fence, car_park, cow) %>%
  na.omit()
