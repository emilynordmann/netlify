...
summary: ''
authors: []
lastmod: '2023-08-01T21:20:56+01:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
You could argue that these blogs are an exercise in procrastination and if you spend any time with me in real life, you'll be questioning why I'm writing all these whilst constantly moaning about workload. If I'm completely honest they are part-procrastination, but, genuinely, writing things down helps me work through and formalise my thoughts and I think I'm much further along than if I hadn't spent the time on these blogs. In the process of writing this blog, I ended up changing some of the guidance as I realised the logic wasn't flowing. 

I've been working on the guidance for my Level 1 essay and in some ways, writing guidance for MCQs was more problematic in that ChatGPT can get them all right very quickly. But in other ways, what is and is not academic misconduct was so clear with MCQs and it's so much harder to draw the lines in the sand when it comes to an essay and provide good advice on how students can and should use AI. I'm much less sure of myself with the essay guidance. I've structured it under three subheadings althought this may well change between now and September (and feedback and ideas are most welcome!). I think it's starting to look ok but my sense of unease remains.
...
I would be really interested to know if there's a difference in how students respond to AI vs human feedback - I would imagine they'd be more likely to assume the human was right but also coming from an AI probably strips the feedback of its emotion which might make them more likely to process it? Interesting times ahead.
...
I am professionally terrified that I am pointing them towards a tool that will potentially harm their development as writers. But abstinence as a policy isn't going to work - if we don't guide them they're going to do it anyway, at least this way I can make them aware of the potential pitfalls. I am also potentially romanticizing the need to develop an individual writing voice based on my own feelings about writing. 
